        ...
        <table class="wp-list-table widefat fixed posts youtube_settings_table" style="width:75%; min-width:820px !important;table-layout: fixed;">
            ...
            <tbody>
                <tr>
                    ...
                    <td>     
                    	<input type="text" name="youtube_embed_width" id="youtube_embed_width" value="<?php echo esc_html($youtube_embed_width); ?>"><span class="befor_input_small_desc">(px)</span>
                    </td>
                </tr> 
                <tr>
                     <td>     
                    ...
                    <td>     
                    	<input type="text" name="youtube_embed_height" id="youtube_embed_height" value="<?php echo esc_html($youtube_embed_height); ?>"><span class="befor_input_small_desc">(px)</span>
                    </td>
                </tr>
				<tr>
                    <td>     
				...
				<tr>
                    ...
                    <td>     
                    	<input type="text" name="youtube_embed_caption" id="youtube_embed_caption" value="<?php echo esc_html($youtube_embed_caption); ?>">
                    </td>
                </tr>				
                <tr>
                    <td>     
                ...
                <tr>
                     <td>     
                    	Player Theme: <span class="pro_subtitle_span">Pro feature!</span> <span title="Select the YouTube Player theme" class="desription_class">?</span>                    
                    </td>
                    <td>     
                ...
                <tr>                     
                	<td>     
                    	Show video in a popup: <span class="pro_subtitle_span">Pro feature!</span> <span title="Set this option if you want to display the YouTube videos in a popup" class="desription_class">?</span>
                    </td>
                    <td class="radio_input">     
